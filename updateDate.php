...
<html>
    ...
    <script>
        function updateData(){
            var xmlhttp = new XMLHttpRequest();
                 ...
                 xmlhttp.open("GET", "updateData.php?id=" + id + "&title=" + title + "&type="+type+"&genre="+genre+"&path="+path, true);
                     xmlhttp.send();
    ...
    <p style="font-size:250%;">Please input the correspounding update information</p>
        <div class="stuff">
            <label class = "id_text">ID of the one you want to update</label>
        ...
        <div class="stuff">
    <button id="add_button" onclick="updateData()">Done</button>
        </div>
    </div>
    </body>
</html>